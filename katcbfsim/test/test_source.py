...
class TestSource(object):
    def setup(self):
        ...
        self.pol_source = Source(
            '{"Q": 0.3, "U": 0.2, "V": -0.1} radec, 0:02:00.00, -30:00:00.0, '
            '(100.0 2000.0 1.0 1.0)')
    ...
    def test_construct_bad_json(self):
        ...
        with assert_raises(ValueError):
            Source('{"Q": 0.3, "U": 0.2, "V" -0.1} radec, 0:02:00.00, -30:00:00.0, '
                   '(100.0 2000.0 1.0 1.0)')
    ...
    def test_description(self):
        assert_equal(
            'radec, 0:02:00.00, -30:00:00.0, (100.0 2000.0 1 1)',
            self.simple_source.description)
        assert_equal(
            '{"Q": 0.3, "U": 0.2, "V": -0.1} radec, 0:02:00.00, -30:00:00.0, (100.0 2000.0 1 1)',
